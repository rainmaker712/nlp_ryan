...
# -*- coding: utf-8 -*-
"""
Created on Sun Jun 11 21:56:32 2017
...
data = pd.read_csv("/home/ryan/dataset/IMDB_Kaggle/labeledTrainData.tsv", header=0, delimiter="\t", quoting=3)
txt = ''
docs = []
sentences = []
sentiments = []
...
#Create training and target
#max len sentence = 512 chars with max num of sentences in doc. 15
#reverse the order of character putting the first character at the end of the 512D vector
...
X: document, sentence, char index
build a sentence encoder from character
Use lambda layer to create onehot encoding of a seq. characeters
because of memory (one-hot encodings = x)
...
#Time layer : run a copy of the encoder to every sentence in doc.
